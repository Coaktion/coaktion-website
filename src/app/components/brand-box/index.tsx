...
export const BrandBox = ({
  ...
  return (
    <div
      ...
      className={`w-full text-white ${gradient} gap-4 shadow-lg hover:shadow-2xl cursor-pointer md:w-1/10 border border-white rounded-xl p-4 flex flex-col items-center text-center max-w-[310px] min-h-[380px]`}
    >
